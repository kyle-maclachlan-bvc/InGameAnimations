...
public class PlayerController2 : MonoBehaviour
{
    ...
    private void HandleLateralMovement()
    {
        ...
        newVelocity = Vector3.ClampMagnitude(new Vector3(newVelocity.x, 0f, newVelocity.x), clampLateralMagnitude);
    ...
    private bool CanRun()
    {
        //The player is moving diagonally at 45 degrees or forward, if so, we can run
